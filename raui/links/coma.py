...
workbook = xlsxwriter.Workbook(u'com/Raui_'+operacia+'.xlsx')
...
class Raui_Com(Spider):
     ...
     def task_generator(self):
	  ...
	  yield Task ('post',url='https://raui.ru/snyat-office-sklad?per_page=50',refresh_cache=True,network_try_count=100)
