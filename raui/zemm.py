...
while True:
     ...
     class Farpost_Zem(Spider):
	  def prepare(self):
	       self.urls = page+'/uchastok?per_page=50'
	       ...
	       #for p in range(1,5):
		    ...
		    #self.num = '1'
	       #print self.num
	       self.workbook = xlsxwriter.Workbook(u'zem/Raui_Земля_'+self.oper+str(i+1)+'.xlsx')
	       self.ws = self.workbook.add_worksheet(u'Raui')
...
time.sleep(5)
os.system("/home/oleg/pars/raui/comm.py")
