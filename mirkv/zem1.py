...
for i in range(25):
     ...
     class MK_Zem(Spider):
	  def prepare(self):
	       ...
	       self.workbook = xlsxwriter.Workbook(u'zem/Mirkvartir_Zemm_'+oper+'_'+str(i+1)+'.xlsx')
	  ...
	  def task_generator(self):
	       for x in range(100):
                    yield Task ('post',url=self.f+'?p=%d'%x,refresh_cache=False,network_try_count=100)
     ...
     bot = MK_Zem(thread_number=1,network_try_limit=1000)
