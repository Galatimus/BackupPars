...
i = 0
l= open('links/zem2.txt').read().splitlines()
dc = len(l)
page = l[i]
...
while True:
     ...
     class Kuz_zap(Spider):
	  ...
	  def task_item(self, grab, task):
	       ...
	       try:
		    ...
		    yield Task('phone',grab=gr,project=projects,refresh_cache=True,network_try_count=20)
	       except IndexError:
     ...
     #bot.setup_queue(backend='mongo', database='Avitozem2',host='192.168.10.200')
     ...
     time.sleep(1)
     print('Save it...')    
     command = 'mount -a'# cifs //192.168.1.6/d /home/oleg/pars -o username=oleg,password=1122,iocharset=utf8,file_mode=0777,dir_mode=0777' #'mount -a -O _netdev'
