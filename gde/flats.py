...
class MK_Kv(Spider):
     def prepare(self):
	  self.workbook = xlsxwriter.Workbook(u'Gde_Жилье.xlsx')
     ...
     def task_generator(self):
	  for x in range(1,335):#78
	       yield Task ('post',url='https://gde.ru/nedvizhimost/kvartiryi/prodau?page=%d'%x,refresh_cache=True,network_try_count=100)
	  for x1 in range(1,335):#4
	       yield Task ('post',url='https://gde.ru/nedvizhimost/kvartiryi/sdam?page=%d'%x1,refresh_cache=True,network_try_count=100)
