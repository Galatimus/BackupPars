...
workbook = xlsxwriter.Workbook(u'comm/0001-0016_00_C_001-0018_ALIANT.xlsx')
...
class Cian_Zem(Spider):
     ...
     def task_generator(self):
	  for line in open('links/aliant.txt').read().splitlines():
...
print('Done!') 
time.sleep(5)
os.system("/home/oleg/pars/small/mlsn_zem.py")
