...
while True:
     ...
     class Nedvizhka_Zem(Spider):
	  def prepare(self):
	       ...
	       self.workbook = xlsxwriter.Workbook(u'zem/Move_Zemm_'+ter+'_'+str(i+1)+'.xlsx')
	  ...
	  def task_generator(self):
	       for x in range(1,self.pag+1):
                    yield Task ('post',url=self.f+'/zemelnie_uchastki/?page=%d'%x,refresh_cache=True,network_try_count=100)
     ...
     bot = Nedvizhka_Zem(thread_number=15,network_try_limit=1000)
