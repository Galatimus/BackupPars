     ...
     class Nedvizhka_Zem(Spider):
	  ...
	  def task_generator(self):
	       for x in range(1,self.pag+1):
                    yield Task ('post',url=self.f+'/arenda_domov/?page=%d'%x,refresh_cache=True,network_try_count=100)
...
time.sleep(5)
os.system("/home/oleg/pars/move/zagp.py")
